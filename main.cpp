    ...
    else
    {
        ...
        for (int i = 0; i < iloscZadan; i++)
            for (int j = 0; j < iloscMaszyn; j++)
            {
                if (i == 0 && j == 0)
                {
                    harmonogram[i][j] = tablicaZadan[i][j];
                    suma += harmonogram[i][j];
                }
                else if (i == 0 && j != 0)
                {
                    harmonogram[i][j] = harmonogram[i][j-1] + tablicaZadan[i][j];
                    suma += harmonogram[i][j];
                }
                else if (i != 0 && j == 0)
                {
                    harmonogram[i][j] = harmonogram[i-1][j] + tablicaZadan[i][j];
                    suma += harmonogram[i][j];
                }
                else
                {
                    harmonogram[i][j] = max(harmonogram[i][j-1], harmonogram[i-1][j]) + tablicaZadan[i][j];
                    suma += harmonogram[i][j];
                }
            }
